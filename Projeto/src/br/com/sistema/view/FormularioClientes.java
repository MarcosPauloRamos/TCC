...
public class FormularioClientes extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       ///função para o botão salvar é criada no ClientesDAO
       //aqui primeiro lemos o que esta na tela e depois passamos para C
       //ClientesDAO atravéz da variavel dao
    ...
    private void btnPesquisaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisaNomeActionPerformed
        ...
        ClientesDAO dao = new ClientesDAO();
        List<Clientes> lista = dao.FiltrarCliente(nome);
        DefaultTableModel dados = (DefaultTableModel) tabela.getModel();
        dados.setNumRows(0);
        for(Clientes c : lista){
            dados.addRow(new Object[]{
    ...
    private void txtNomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomeKeyPressed
        //aqui faz a mesma função de pesquisar um cliente na tela de cadastro
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       ///função para o botão editar é criada no ClientesDAO
       //aqui primeiro lemos o que esta na tela e depois passamos para C
       //ClientesDAO atravéz da variavel dao
        Clientes obj = new Clientes();
        obj.setNome(txtNome.getText());
