...
public class FormularioEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        painel_inventario = new javax.swing.JPanel();
        ...
        jLabel9.setText("Saldo de entrada");

        btnadd.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnadd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sistema/imagens/add1.png"))); // NOI18N
        ...
        btnAtualizarEstoque.setText("atualizar inventario");
        ...
        javax.swing.GroupLayout painel_inventarioLayout = new javax.swing.GroupLayout(painel_inventario);
        painel_inventario.setLayout(painel_inventarioLayout);
        painel_inventarioLayout.setHorizontalGroup(
            painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(painel_inventarioLayout.createSequentialGroup()
                .addGroup(painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel3)
                    .addComponent(jLabel4)
                    .addComponent(jLabel2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(painel_inventarioLayout.createSequentialGroup()
                        .addGroup(painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, painel_inventarioLayout.createSequentialGroup()
                            ...
                            .addComponent(txtDescricao, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 275, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        painel_inventarioLayout.setVerticalGroup(
            painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(painel_inventarioLayout.createSequentialGroup()
                .addGroup(painel_inventarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
        ...
        painel_guias.addTab("Dados do produto", painel_inventario);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(painel_guias, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        util.LimpaTela(painel_inventario);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
       ...
       if(obj.getDescricao()!= null){
           ...
           txtqtd.setText(String.valueOf(obj.getQuantidade_estoque()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        id_produto = Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString());
        ...
        txtqtd.setText(tabela.getValueAt(tabela.getSelectedRow(), 3).toString());
    }//GEN-LAST:event_tabelaMouseClicked

    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        // adiconar uma quantidade nova no estoque (somar)
        try {
            int qtd_atual, qtd_entradas;
            qtd_atual = Integer.valueOf(txtqtd.getText());
            qtd_entradas = Integer.valueOf(txtentrada.getText());
            qtd_atualizada = qtd_atual + qtd_entradas;
            ProdutosDAO daop = new ProdutosDAO();
            daop.AdicionarEstoque(id_produto, qtd_atualizada);
        } catch (Exception erro) {
            JOptionPane.showMessageDialog(null, "erro ao adicionar o produto em estoque"+erro);
        }
        Utilitarios util = new Utilitarios(); 
        util.LimpaTela(painel_inventario);
    ...
    private void btnAtualizarEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarEstoqueActionPerformed
        // atualiza o valor no estoque (substituir)
        try {
            int  qtd_entradas;
            qtd_entradas = Integer.valueOf(txtentrada.getText());
            ProdutosDAO daop = new ProdutosDAO();
            daop.AtualizarInventario(id_produto, qtd_entradas);
        } catch (Exception erro) {
            JOptionPane.showMessageDialog(null, "erro ao atualizar o produto em estoque"+erro);
        }
        Utilitarios util = new Utilitarios(); 
        util.LimpaTela(painel_inventario);
    ...
    private javax.swing.JPanel painel_inventario;
